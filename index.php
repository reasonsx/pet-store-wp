...
<div class="hero-container">
        ...
        <div class="offers">
            <?php if (have_posts()) : ?>
                <?php while (have_posts()) : the_post(); ?>
                    <div class="offer">
                        <img src="<?php echo esc_url(get_field('offer-image')); ?>" alt="<?php echo esc_attr(get_the_title()); ?>">
    ...
    <div class="categories-container">
        ...
        <div class="categories">
            <div class="category-box"><img src="<?php echo esc_url(get_template_directory_uri() . '/img/Cat.png'); ?>" alt="Cat"></div>
            <div class="category-box"><img src="<?php echo esc_url(get_template_directory_uri() . '/img/Dog.png'); ?>" alt="Dog"></div>
            <div class="category-box"><img src="<?php echo esc_url(get_template_directory_uri() . '/img/Fish.png'); ?>" alt="Fish"></div>
            <div class="category-box"><img src="<?php echo esc_url(get_template_directory_uri() . '/img/Bird.png'); ?>" alt="Bird"></div>
            <div class="category-box"><img src="<?php echo esc_url(get_template_directory_uri() . '/img/Hamster.png'); ?>" alt="Hamster"></div>
        </div>
    </div>
